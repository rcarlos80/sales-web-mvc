...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            SalesRecord r14 = new SalesRecord(14, new DateTime(2018, 09, 04), 3000.0, SaleStatus.Billed, s6);
            ...
            SalesRecord r17 = new SalesRecord(17, new DateTime(2018, 10, 17), 12000.0, SaleStatus.Billed, s2);
            SalesRecord r18 = new SalesRecord(18, new DateTime(2018, 10, 24), 6000.0, SaleStatus.Billed, s2);
            SalesRecord r19 = new SalesRecord(19, new DateTime(2018, 10, 19), 11000.0, SaleStatus.Billed, s4);
            SalesRecord r20 = new SalesRecord(20, new DateTime(2018, 10, 12), 8000.0, SaleStatus.Billed, s6);
            SalesRecord r21 = new SalesRecord(21, new DateTime(2018, 10, 15), 3000.0, SaleStatus.Billed, s1);
            SalesRecord r22 = new SalesRecord(22, new DateTime(2018, 10, 17), 2000.0, SaleStatus.Billed, s3);
            SalesRecord r23 = new SalesRecord(23, new DateTime(2018, 10, 19), 11000.0, SaleStatus.Billed, s5);
            SalesRecord r24 = new SalesRecord(24, new DateTime(2018, 10, 12), 8000.0, SaleStatus.Billed, s2);
            SalesRecord r25 = new SalesRecord(25, new DateTime(2018, 10, 31), 7000.0, SaleStatus.Billed, s4);
            SalesRecord r26 = new SalesRecord(26, new DateTime(2018, 10, 06), 5000.0, SaleStatus.Billed, s5);
            SalesRecord r27 = new SalesRecord(27, new DateTime(2018, 10, 13), 9000.0, SaleStatus.Billed, s1);
